...
int main() {
	...
	sqlstr += "writer VARCHAR(15)CHARACTER SET gb2312 COLLATE gb2312_chinese_ci NULL,";
	sqlstr += "intro VARCHAR(200)CHARACTER SET gb2312 COLLATE gb2312_chinese_ci NULL,";
	...
	sqlstr += "teacher_name VARCHAR(20)CHARACTER SET gb2312 COLLATE gb2312_chinese_ci NULL,";
	sqlstr += "teacher_phone VARCHAR(20),";
	...
	//向表中插入数据
	sqlstr =
		"INSERT INTO book VALUES('75148','45','htr','yth',4,6,'无');";
	if (0 == mysql_query(&mysql, sqlstr.c_str())) {
