...
file_1 = "D:/XueLangData/round1/test_new"
mkdir(file_1)
resize_img(dir="D:/XueLangData/round1/xuelang_round1_test_b", savepath="D:/XueLangData/round1/test_new", height=499, width=499)

model = load_model("D:/XueLangData/round1/model0.hdf5")

file_dir = "D:/XueLangData/round1/test_new"
fn = []
y_label = []
...
dataframe.to_csv(("../submit/submit_" + datetime.datetime.now().strftime('%Y%m%d_%H%M%S') + ".csv"), index=False,
                 sep=',')
